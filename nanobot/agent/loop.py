...
class AgentLoop:
    ...
    def __init__(
        ...
        def archive_file_cap(
            messages: list[dict[str, Any]],
            *,
            session_key: str,
        ) -> None:
            self.context.memory.raw_archive(messages, session_key=session_key)
            self.history_store.insert_messages(session_key, messages, "file_cap")

        self.sessions.set_file_cap_archiver(archive_file_cap)
        ...
        self._vision_provider_name = vision_provider_name
    ...
    def _persist_user_message_early(
        ...
        **kwargs: Any,
        ...
        # 而不是用已清空的 msg.media。
        persist_media = original_media or msg.media or []

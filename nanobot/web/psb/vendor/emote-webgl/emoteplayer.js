...
var EmoteDevice = function () {
  ...
  _createClass(EmoteDevice, [{
    ...
    value: function onStartAnimation() {
      if (typeof EmoteModule !== "undefined" && typeof EmoteModule.onStartEmoteAnimation !== "undefined") EmoteModule.onStartEmoteAnimation(this);else this.requestId = requestAnimationFrame(this.drawAnimation.bind(this));
    }
  }, {
    key: "onStopAnimation",
    value: function onStopAnimation() {
      if (typeof EmoteModule !== "undefined" && typeof EmoteModule.onStopEmoteAnimation !== "undefined") EmoteModule.onStopEmoteAnimation(this);else cancelAnimationFrame(this.requestId);
    }
  }, {
    key: "onContinueAnimation",
    value: function onContinueAnimation() {
      if (typeof EmoteModule !== "undefined" && typeof EmoteModule.onStartEmoteAnimation !== "undefined") ;else this.requestId = requestAnimationFrame(this.drawAnimation.bind(this));
    }
  }, {
    key: "kickAnimation",

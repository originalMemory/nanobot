...
- [x] 静态资源定位支持镜像路径回退
- [x] 增加源码 `dist` 缺失场景测试
- [x] 在 compose 恢复 `OAUTH_CLI_KIT_TOKEN_PATH`
...
- Codex OAuth 继续读取挂载目录 `.nanobot/auth/codex.json`
...
- [x] 相关测试与 lint 通过
- [x] compose 将 Codex token 路径注入所有服务
